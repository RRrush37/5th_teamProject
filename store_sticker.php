...
<head>
    ...
    <title>store_sticker</title>
    <link rel="stylesheet" href="/CSS/global.css">
    <link rel="stylesheet" href="./CSS/store/store_sticker.css">
...
<body>
    ...
    <div class="stickers">
        ...
        <div class="sticker_wrapper">
            <div class="sticker_choose">
                <ul>
                    <li>
                        <img class="sticker" src="./IMG/store/sticker.png" alt="">
                        <div class="money">
    ...
    <!-- text -->
    <div class="sticker_lightbox1 text_none">
        <div class="sticker_text">
            <div class="close1">
                <i class="fa-solid fa-xmark"></i>
            </div>
            <article>
                <div class="text">
                    <img class="main1" src="./IMG/store/sticker.png" alt="">
                    <h2>企鵝貼圖</h2>
                </div>
    ...
    <!-- gift -->
    <div class="sticker_lightbox2 gift_none">

        <div class="sticker_gift">
            <div class="close2">
                <i class="fa-solid fa-xmark"></i>
            </div>
            <article>
    ...
    <script src="./JS/store/store_sticker.js"></script>
