...
<body>
    ...
    <div class="wrapper">
        <section class="room">
            <p class="room_num">房號:{{room_num}}</p>
            <p class="room_password">密碼:{{room_password}}</p>
                ...
                <div class="left_player">
                    <div id="player1" data-index="1" class="seat haveplayer">
                        ...
                        <div class="player_state_box">
                            ...
                            <div class="player_state" data-ready="已準備" data-prepare="準備中"
                            data-out="已出局">
                            準備中
                            </div>
                    ...
                    <div id="player2" data-index="2" class="seat haveplayer">
                        ...
                        <div class="player_state_box">
                            ...
                            <div class="player_state ready" data-ready="已準備" data-prepare="準備中"
                            data-out="已出局">
                            已準備
                            </div>
                            <button class="v_btn none">Vote</button>
                ...
                <div class="right_player">
                    ...
                    <div id="player8" data-index="8"  class="seat">
                        <div class="player_state_box">
                            ...
                            <div class="player_state none" data-ready="已準備" data-prepare="準備中"
                            data-out="已出局">
            ...
            <div id="center_box">
                ...
                <div id="witch_box" class="none">
                    <div id="witch_text" data-poison="請選擇投毒對象" data-death="昨晚死亡的玩家為 {{player_seat}}"
                    data-antidote="是否要給予解藥?"></div>
                    <div class="btn_box">
    ...
    <script>
        ...
        //陣列設計
        let player_index = 0 ; //用來儲存目前玩家的座位
        ...
        let witchArr = {"saved": -1, "poisoned": -1 };
        ...
        let round = [1, ""]; //用於儲存目前回合狀態，{開局階段、狼人回合、女巫回合、預言家回合、夜晚出局回合、發言回合、投票回合、白天出局回合、遊戲結束、結算回合}
        ...
        if ( round[1] == "開局階段") {
            ...
            werewolveRound();
        } else if ( round[1] == "女巫回合" ) {
            witchRound();
        } else if ( round[1] == "預言家回合" ) {
            seerRound();
        } else if ( round[1] == "發言回合" ) {
            daySpeaking(isvoted);
        } else if ( round[1] == "投票回合" ) {
            vote(isvoted);
        } else if ( round[1] == "結算" ) {
            settle_game();
        }
        ...
        if ( round[1] == "" ){
            ...
            // ready_box_el.setAttribute("style", "display : flex");
            let second = 3; //3秒
            if ( player_index != 0 ) {
            ...
            game_start_btn.addEventListener("click", function(){
                ...
                if ( all_ready ) {
                    ...
                    round[1] = ["開局階段"];
                    ready_box_el.classList.add("none");
        ...
        function viewCard(){ //依位置查看角色牌身份
            ...
            switch (player_role[player_index]){
        ...
        function werewolveRound(){ // 狼人回合，狼人開始投票
            ...
            let have_been_vote = false, have_been_confirm = false ;
        ...
        game_ready_btn.addEventListener("click", function(){
            player_state_el[player_index].classList.toggle("ready");

            if (player_state_el[player_index].classList.contains("ready")) {
