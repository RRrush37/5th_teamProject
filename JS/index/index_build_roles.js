...
$.ajax({
    ...
    success: function (response) {
        ...
        for(let i = 0; i < response.length; i++){
            ...
            if ( response[i].initialItem == 1 ) {

                if ( response[i].itemType == "hair" ) {
                    myitem.hair = response[i].storeID ;
                } else if ( response[i].itemType == "clothes" ) {
                    myitem.clothes = response[i].storeID ;
                } else if ( response[i].itemType == "bottoms" ) {
                    myitem.bottoms = response[i].storeID ;
                } else if ( response[i].itemType == "accessories1" ) {
                    myitem.accessories1 = response[i].storeID ;
                } else if ( response[i].itemType == "accessories2" ) {
                    myitem.accessories2 = response[i].storeID ;
                } else if ( response[i].itemType == "accessories3" ) {
                    myitem.accessories3 = response[i].storeID ;
                } else if ( response[i].itemType == "eyebrow" ) {
                    myitem.eyebrow = response[i].storeID ;
                } else if ( response[i].itemType == "eye" ) {
                    myitem.eye = response[i].storeID ;
                } else if ( response[i].itemType == "mouth" ) {
                    myitem.mouth = response[i].storeID ;
                }
        ...
        send.addEventListener("click", function(){
            ...
            $.ajax({
                method: "POST",
                url: "php/putInitialItemToMember.php",
                data: {
                    "hair" : doll.hair,
